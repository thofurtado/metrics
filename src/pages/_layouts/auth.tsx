...
export function AuthLayout() {
  return (
    ...
    <div className="grid min-h-screen grid-cols-1 antialiased lg:grid-cols-2">
      ...
      */}
      <div
        className="// Gradiente: comece escuro, termine 
        mais claro (tendência moderna) hidden h-full flex-col justify-between border-r
        border-minsk-800/20 bg-gradient-to-br from-minsk-700 
        to-minsk-500 p-10 text-white lg:flex
      "
      >
      ...
      <div className="flex flex-col items-center justify-center p-8">
        ...
        <div
          className="w-full max-w-sm rounded-2xl bg-white p-6 shadow-2xl shadow-gray-300/50 
                      dark:bg-gray-900 dark:shadow-gray-950/50 
                      sm:p-8 lg:max-w-md lg:p-10"
        >
          <Outlet />
        </div>
      </div>
