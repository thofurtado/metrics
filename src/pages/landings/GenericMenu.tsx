...
export default function GenericMenu({ tenantName }: GenericMenuProps) {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-slate-50 p-4">
      <div className="w-full max-w-md space-y-6 overflow-hidden rounded-2xl border border-slate-100 bg-white p-8 text-center shadow-xl">
        <div className="mx-auto mb-2 flex h-20 w-20 items-center justify-center rounded-full bg-indigo-100">
        ...
        <div className="space-y-2">
          <h1 className="text-2xl font-bold text-slate-900">
            Bem-vindo ao(à){' '}
            <span className="text-indigo-600">{tenantName}</span>!
          </h1>
        ...
        <div className="flex justify-center pt-4">
          <div className="inline-flex items-center justify-center gap-2 rounded-full bg-indigo-50 px-4 py-2 text-sm font-medium text-indigo-600">
