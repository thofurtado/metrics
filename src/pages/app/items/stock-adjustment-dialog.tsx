...
export function StockAdjustmentDialog({
  ...
  return (
    ...
    >
      ...
      <Form {...form}>
        <form
          onSubmit={form.handleSubmit(handleAdjustStock)}
        ...
        >
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      field.value === 'IN'
                        ...
                        : 'border-muted text-muted-foreground hover:border-emerald-200 hover:bg-emerald-50/50',
                    )}
                  >
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      field.value === 'OUT'
                        ...
                        : 'border-muted text-muted-foreground hover:border-rose-200 hover:bg-rose-50/50',
                    )}
                  >
                  ...
                  <FormControl>
                    <div className="relative mx-auto">
                      <Input
                        ...
                        step="0.01"
                        {...field}
                        className="h-16 rounded-xl border-2 border-primary/20 bg-muted/20 text-center text-3xl font-bold tabular-nums shadow-sm focus-visible:border-primary focus-visible:ring-0"
                      />
                    </div>
                  </FormControl>
                  <FormMessage />
                    ...
                    <FormControl>
                      <div className="relative mx-auto">
                        <Input
                          ...
                          step="0.01"
                          {...field}
                          className="h-16 rounded-xl border-2 border-emerald-500/20 bg-emerald-50/20 text-center text-3xl font-bold tabular-nums text-emerald-700 shadow-sm focus-visible:border-emerald-500 focus-visible:ring-0 dark:text-emerald-400"
                        />
                      </div>
                    </FormControl>
                    <FormMessage />
                ...
                >
                  <FormControl>
                    <SelectTrigger
                      type="button"
                      className={cn(
                        'h-12 w-full border-muted-foreground/20 bg-muted/20 font-normal hover:bg-muted/30',
          ...
          <ResponsiveDialogFooter className="flex-col gap-3 pt-4 sm:flex-row">
            ...
            <Button
              type="submit"
              className={cn(
                'h-12 w-full px-8 font-bold shadow-md sm:w-auto',
                isEntry
