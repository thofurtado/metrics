...
// Importação do useQueryClient adicionada
...
export function TransactionIncome() {
  // Inicialização do useQueryClient
  const queryClient = useQueryClient()
  
  const { mutateAsync: transaction } = useMutation({
    mutationFn: createTransaction,
    // Adicionamos a invalidação das queries de setores e contas no sucesso da transação
    onSuccess: () => {
        // Invalida a query de setores
        queryClient.invalidateQueries({ queryKey: ['sectors'] }) 
        // Invalida a query de contas
        queryClient.invalidateQueries({ queryKey: ['accounts'] }) 
        // Adicione outras invalidações importantes aqui, como métricas do painel
    }
  })
  useEffect(() => {
