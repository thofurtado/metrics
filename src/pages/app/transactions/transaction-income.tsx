...
// Componente de Calendário Simples e Direto (MESMO das despesas)
...
export function TransactionIncome() {
  ...
  async function onSubmit(data: FormSchemaType) {
    try {
      console.log('Dados enviados para receita:', {
        date: data.date,
      ...
      console.log('Dados processados para receita:', transactionData)
              ...
              <FormItem className="flex w-full flex-row items-center space-x-2 border-b-2">
                ...
                <FormControl>
                  <Input
                    ...
                    step="0.01"
                    placeholder="0,00"
                    className="border-none text-center text-lg font-semibold text-vida-loca-600 focus:!ring-transparent"
                  />
                </FormControl>
              </FormItem>
            )}
                    ...
                    <SelectContent>
                      {sectors &&
                        sectors.data.sectors
                          .filter((sector) => sector.type === 'in') // ✅ Filtro para receitas
                          .map((sector) => (
