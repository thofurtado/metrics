...
import { TreatmentTableFilters } from './treatment-table-filters'
      ...
      <div className="flex flex-col gap-4">
        <div className="flex-start  flex w-full flex-row place-content-between">
          ...
          <Button
            ...
            className="bg-vida-loca-400 hover:bg-vida-loca-500 dark:bg-vida-loca-500 dark:hover:bg-vida-loca-400 ml-3 mt-auto w-auto "
          >
