...
export function UpcomingTransactionsModal({
  open,
  onOpenChange,
}: UpcomingTransactionsModalProps) {
      ...
      <DialogContent className="flex max-h-[85vh] max-w-4xl flex-col p-6">
        <DialogHeader className="border-b pb-4">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Listagem de todas as contas a pagar previstas de hoje até as
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center text-muted-foreground">
              ...
              <p className="text-base font-semibold">
                Nenhuma conta agendada encontrada.
              </p>
              <p className="text-sm">
                Não há despesas previstas para os próximos 14 dias.
              </p>
            </div>
          ) : (
              ...
              <Table>
                <TableHeader className="bg-muted/50">
                  <TableRow>
                    ...
                    <TableHead className="w-2/6 font-semibold">
                      Descrição
                    </TableHead>
                    <TableHead className="w-2/6 font-semibold">
                      Fornecedor
                    </TableHead>
                    <TableHead className="w-1/6 text-right font-semibold">
                      Valor
                    </TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {transactions.map((t) => (
                    ...
                    >
                      <TableCell className="whitespace-nowrap font-mono text-xs font-semibold text-amber-700">
                      ...
                      <TableCell className="whitespace-nowrap text-right font-bold tabular-nums text-amber-600">
