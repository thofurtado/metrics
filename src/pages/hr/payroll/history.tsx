...
import { ArrowLeft, CheckCircle2, Clock, Filter } from 'lucide-react'
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Consulte todos os pagamentos realizados e pendentes.
          </p>
        </div>
      </div>
            ...
            <div className="space-y-2">
              ...
              <Select value={type} onValueChange={setType}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="VALE_TRANSPORTE">
                    Vale Transporte
                  </SelectItem>
                  <SelectItem value="PONTUACAO_10">
                    Pontuação (Rateio)
                  </SelectItem>
                </SelectContent>
              </Select>
              ...
              {isLoading ? (
                ...
                entries.map((entry: any) => (
                  <TableRow key={entry.id}>
                    <TableCell>
                      {parseDateOnly(entry.referenceDate).toLocaleDateString()}
                    </TableCell>
                    <TableCell>
